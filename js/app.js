    ...
    (() => {
        ...
        function addLoadedClass() {
            if (!document.documentElement.classList.contains("loading")) window.addEventListener("load", (function() {
                setTimeout((function() {
                    ...
                    const svgLogo = document.querySelector(".main-block__logo svg");
                    if (svgLogo) svgLogo.classList.add("active");
                }), 0);
            }));
        }
        function getHash() {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) new swiper_core_Swiper(".swiper", {
                ...
                pagination: {
                    el: ".footer-main-block__pagination",
                    clickable: true
                },
                navigation: {
        ...
        window.addEventListener("load", (() => {
            document.documentElement.addEventListener("click", (e => {
                ...
                if (eventTarget.closest(".actions-header__open-button")) {
                    document.documentElement.classList.add("search-open");
                    searchField.classList.remove("hidden");
                } else if (!eventTarget.closest(".search-header")) {
